...
# df=pd.read_csv(StringIO(pymisp.search(return_format='csv', date_from='2019/05/21', category='Network activity', type=('ip-src' or 'ip-dst'))))
df=pd.read_csv(StringIO(pymisp.search(return_format='csv', date_from='2010/05/21')))
